...
import { Globe, Mail, Linkedin, Facebook, Instagram, Twitter, Github } from "lucide-react"
    ...
    >
      <div className="relative w-32 h-32 md:w-40 md:h-40 mb-4">
        <Image
          ...
          src={
            member.image ||
            `https://placehold.co/200x200/E2E8F0/4A5568?text=${
              member.name
                ? member.name
                    .split(" ")
                    .map((n) => n[0])
          ...
          height={160}
          onError={(e) => {
            e.target.src = `https://placehold.co/200x200/E2E8F0/4A5568?text=${
              member.name
                ? member.name
                    .split(" ")
                    .map((n) => n[0])
      ...
      <p className="text-sm font-medium text-gray-800 dark:text-gray-300 mb-6 px-3 py-1 bg-green-100 dark:bg-gray-800 rounded-full">
        {member.position || member.role || member.bio || "Position"}
      </p>
      <div className="flex space-x-3">
        {member.twitter && (
          <a
            href={member.twitter}
            className=" p-2 text-gray-500 flex justify-center items-center hover:text-white bg-gray-100 dark:bg-gray-800 hover:bg-[#09509E] dark:hover:bg-[#09509E] rounded-full transition-all duration-300 hover:scale-110 hover:shadow-lg"
        ...
        {member.instagram && (
          <a
            ...
            className="p-2 text-gray-500 hover:text-white bg-gray-100 dark:bg-gray-800 hover:bg-gradient-to-br hover:from-purple-500 hover:to-pink-500 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-lg"
