    ...
    <div className="relative overflow-hidden bg-white py-20 px-4 font-outfit">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <svg className="absolute top-0 left-0 w-full h-full" viewBox="0 0 1000 200" fill="none">
          ...
          <path d="M0,100 Q250,75 500,100 T1000,100" stroke="url(#gradient1)" strokeWidth="2" fill="none" />
          <path d="M0,125 Q300,100 600,125 T1000,125" stroke="url(#gradient2)" strokeWidth="1.5" fill="none" />
        </svg>
