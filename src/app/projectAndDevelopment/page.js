...
import projectsDataRaw from "../../data/projectsData"
...
export default function ProjectDevelopmentPage() {
  ...
  console.log("ProjectDevelopmentPage - projectsData:", projectsData)
  console.log("ProjectDevelopmentPage - searchTerm:", searchTerm)
  console.log("ProjectDevelopmentPage - activeFilter:", activeFilter)
  ...
  console.log("Search filtered projects:", searchFilteredProjects)

  // Step 2: Filter based on active filter tab
